...
### [<img src="https://static-www.onlyoffice.com/v9.5.0/images/favicons01/favicon.ico" height="24px" alt="OnlyOffice Desktop Editors"> OnlyOffice Desktop Editors](https://www.onlyoffice.com/download-desktop.aspx)

An office suite that allows to create, view and edit local documents.

*Solid LibreOffice alternative.*
...
Import following [dash_to_panel.config](https://raw.githubusercontent.com/mr-valters/gists/main/assets/dash_to_panel.config) file into *Dash to Panel* extension
