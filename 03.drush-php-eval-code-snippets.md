...
So, here we have or first **awesome PHP code snippet** that _outputs all the environment variables from the server_:
...
**Note**: _All the **PHP snippets** here are tailored for wrapping in **single quotes**_ for consistency
